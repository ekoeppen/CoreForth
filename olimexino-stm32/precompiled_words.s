    ...
    .word CR, LPARENSQUOTRPAREN, 0x52494405, 0x203A, TYPE, DOT, LPARENSQUOTRPAREN, 0x3A504504, 0x20, TYPE, DUP, DOT, DUP, USB_BTABLE_RX, FETCH, TWOMUL, USB_PMA, PLUS, OVER, USB_BTABLE_RXNUM, FETCH, LIT, 0x3FF, AND, TWOMUL, DUMP, CELLS, USB_EPZR, PLUS, LIT, 0x8080, SWAP, CLEAR_BITS, EXIT
    ...
    .word CR, LPARENSQUOTRPAREN, 0x54455307, 0x203A5055, TYPE, LIT, 0x0, USB_BTABLE_RX, FETCH, TWOMUL, USB_PMA, PLUS, DUP, CFETCH, DOT, ONEPLUS, DUP, CFETCH, DOT, LIT, 0x3, PLUS, DUP, HFETCH, DOT, FOURPLUS, DUP, HFETCH, DOT, FOURPLUS, HFETCH, DOT, EXIT

    defword "EP-HANDLER", EP_HANDLER, 0x0
    .word LPARENSQUOTRPAREN, 0x30504504, 0x202D20, TYPE, OVER, CELLS, USB_EPZR, PLUS, FETCH, LIT, 0x800, AND, QBRANCH, 0x10, EPZ_SETUP, BRANCH, 0x4, USB_DEFAULT_CTR, EXIT
