    ...
    defconst "NVIC_SETENA_BASE", NVIC_SETENA_BASE, 0xE000E100


    defconst "NVIC_ACTIVE_BASE", NVIC_ACTIVE_BASE, 0xE000E300
    ...
    .word LPARENSQUOTRPAREN, 0x42535509, 0x73657220, 0x7465, TYPE, EXIT

    defword "USB-IRQ", USB_IRQ, 0x0
    .word LIT, 0x0, USB_ISTR, DUP, FETCH, DUP, DOT, USB_ISTR_SHADOW, STORE, STORE, RETI

    defword "USB-IRQ-ENABLE", USB_IRQ_ENABLE, 0x0
    .word LIT, USB_IRQ, DUP, LIT, 0x22, PLUS, CELLS, IVT, PLUS, STORE, LIT, 0x23, PLUS, CELLS, IVT, PLUS, STORE, LIT, 0x180000, NVIC_SETENA_BASE, STORE, EXIT

    defword "USB-ENABLE", USB_ENABLE, 0x0
    .word LIT, 0x0, USB_ISTR_SHADOW, STORE, USB_IRQ_ENABLE, LIT, 0xFE10, USB_CNTR, STORE, EXIT
