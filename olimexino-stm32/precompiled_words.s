    ...
    .word LIT, 0x8080, USB_EPZR, CLEAR_BITS, LPARENSQUOTRPAREN, 0x54455307, 0x203A5055, TYPE, LIT, 0x0, USB_BTABLE_RX, DUP, CFETCH, DOT, ONEPLUS, DUP, CFETCH, DOT, LIT, 0x3, PLUS, DUP, HFETCH, DOT, FOURPLUS, DUP, HFETCH, DOT, FOURPLUS, HFETCH, DUP, LIT, 0x0, USB_BTABLE_TXNUM, STORE, USB_DEVICE_DESCRIPTOR, LIT, 0x0, USB_BTABLE_TX, LIT, 0x24, CMOVE, USB_EPZR, DUP, FETCH, LIT, 0xCFCF, AND, LIT, 0x3030, OR, SWAP, STORE, EXIT
    ...
    .word LIT, 0x80, USB_EPZR, CLEAR_BITS, LPARENSQUOTRPAREN, 0x4E4902, TYPE, EXIT
    ...
    defword "BUF-PTR", BUF_PTR, 0x0
    .word CREATE, LIT, 0x2, CELLS, ALLOT, LPARENDOESGTRPAREN
    .set BUF_PTR_XT, .
    .word 0x47884900, DODOES + 1, DUP, CELL, PLUS, EXIT

    defword "BUF-PTR!", BUF_PTRSTORE, 0x0
    .word ROT, SWAP, STORE, STORE, EXIT

    defword "COPY-OUT", COPY_OUT, 0x0
    .word LIT, 0x0, ROT, STORE, SWAP, TWODUP, USB_BTABLE_TXNUM, STORE, ROT, FETCH, MINUSROT, USB_BTABLE_TX, SWAP, CMOVEGT, EXIT

    defword "BUF-PTR-OUT", BUF_PTR_OUT, 0x0
    .word ROT, TUCK, FETCH, OVER, SWAP, MINUS, DUP, ZLT, QBRANCH, 0x14, DROP, COPY_OUT, BRANCH, 0x14, LPARENSQUOTRPAREN, 0x41505305, 0x4543, TYPE, EXIT

    defvar "EP0-PENDING", EPZ_PENDING, 0x8


    defword "EP0-PENDING-REMAINDER", EPZ_PENDING_REMAINDER, 0x0
    .word EPZ_PENDING, SLICENUM, MINUS, DUP, ZGT, AND, EXIT

    defword "EP0-SEND-ALL", EPZ_SEND_ALL, 0x0
    .word LPARENSQUOTRPAREN, 0x6E65530B, 0x676E6964, 0x6C6C6120, TYPE, EPZ_PENDING, SLICEFETCH, RGT, LIT, 0x0, USB_BTABLE_TX, RFETCH, CMOVE, GTR, LIT, 0x0, USB_BTABLE_TXNUM, STORE, LIT, 0x0, EPZ_PENDING, SLICENUMSTORE, EXIT

    defword "EP0-SEND-PARTIAL", EPZ_SEND_PARTIAL, 0x0
    .word LPARENSQUOTRPAREN, 0x6E655313, 0x61702064, 0x61697472, 0x7075206C, 0x206F7420, TYPE, DOT, EXIT

    defword "EP0-SEND-PENDING", EPZ_SEND_PENDING, 0x0
    .word EPZ_PENDING, SLICENUM, OVER, LTEQU, QBRANCH, 0x14, DROP, EPZ_SEND_ALL, BRANCH, 0x8, EPZ_SEND_PARTIAL, EXIT
