    ...
    defvar "USB-ISTR-SHADOW", USB_ISTR_SHADOW, 0x4
    ...
    .word LIT, 0x0, USB_BTABLE, STORE, USB_PMA, LIT, 0x400, LIT, 0x0, FILL, LIT, 0x3210, USB_EPZR, STORE, LIT, 0x140, LIT, 0x0, USB_BTABLE_RX, HSTORE, LIT, 0x8400, LIT, 0x0, USB_BTABLE_RXNUM, HSTORE, LIT, 0x80, LIT, 0x0, USB_BTABLE_TX, HSTORE, LIT, 0x40, LIT, 0x0, USB_BTABLE_TXNUM, HSTORE, LIT, 0x0, USB_EPONER, STORE, LIT, 0xC0, LIT, 0x1, USB_BTABLE_TX, HSTORE, LIT, 0x40, LIT, 0x1, USB_BTABLE_TXNUM, HSTORE, LIT, 0x620, USB_EPTWOR, STORE, LIT, 0x100, LIT, 0x2, USB_BTABLE_TX, HSTORE, LIT, 0x40, LIT, 0x2, USB_BTABLE_TXNUM, HSTORE, LIT, 0x30, USB_EP3R, STORE, LIT, 0x110, LIT, 0x3, USB_BTABLE_RX, HSTORE, LIT, 0x8400, LIT, 0x3, USB_BTABLE_RXNUM, HSTORE, LIT, 0x80, USB_DADDR, STORE, EXIT

    defword "USB-SUSPEND", USB_SUSPEND, 0x0
    .word LIT, 0xC, USB_CNTR, SET_BITS, EXIT

    defword "USB-WAKE", USB_WAKE, 0x0
    .word LIT, 0x4, USB_CNTR, CLEAR_BITS, LIT, 0xBD00, USB_CNTR, STORE, EXIT

    defword "USB-TRANSFER", USB_TRANSFER, 0x0
    .word CR, LPARENSQUOTRPAREN, 0x6172540A, 0x6566736E, 0x203A72, TYPE, USB_CNTR, FETCH, DOT, USB_ISTR, FETCH, LIT, 0xF, AND, TUCK, DOT, LIT, 0x10, AND, DOT, DUP, USB_BTABLE_RX, FETCH, TWOMUL, USB_PMA, PLUS, OVER, USB_BTABLE_RXNUM, LIT, 0x3FF, AND, DUMP, DUP, CELLS, USB_EPZR, PLUS, DUP, FETCH, DUP, DOT, LIT, 0x7F7F, AND, SWAP, STORE, CR, EXIT

    defword "USB-IRQ", USB_IRQ, 0x0
    .word LIT, 0x0, USB_ISTR, DUP, FETCH, DUP, DOT, LIT, 0x400, OVER, AND, QBRANCH, 0x8, USB_RESET, LIT, 0x800, OVER, AND, QBRANCH, 0x8, USB_SUSPEND, LIT, 0x1000, OVER, AND, QBRANCH, 0x8, USB_WAKE, LIT, 0x8000, OVER, AND, QBRANCH, 0x8, USB_TRANSFER, USB_ISTR_SHADOW, STORE, STORE, RETI
    ...
    .word USB_DISC_CONFIG, LIT, 0x0, USB_DISCSTORE, LIT, 0x0, USB_ISTR_SHADOW, STORE, USB_SET_IRQ_HANDLER, LIT, 0x180000, NVIC_SETENA_BASE, STORE, LIT, 0x1, USB_CNTR, STORE, LIT, 0x0, USB_CNTR, STORE, LIT, 0x0, USB_ISTR, STORE, LIT, 0x1C00, USB_CNTR, STORE, LIT, 0x0, USB_ISTR, STORE, LIT, 0xBD00, USB_CNTR, STORE, EXIT
