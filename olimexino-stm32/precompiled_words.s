    ...
    .word USB_DEVICE_DESCRIPTOR, LIT, 0x24, EPZ_PENDING, SLICESTORE, EPZ_REQ_LENGTH, FETCH, EPZ_SEND_PENDING, LIT, 0x3, LIT, 0x0, EP_TX_STATESTORE, EXIT
    ...
    .word LIT, 0x8080, USB_EPZR, CLEAR_BITS, LPARENSQUOTRPAREN, 0x74655307, 0x203A7075, TYPE, LIT, 0x0, USB_BTABLE_RX, DUP, CFETCH, EPZ_REQ_TYPE, STORE, ONEPLUS, DUP, CFETCH, EPZ_REQ, STORE, LIT, 0x3, PLUS, DUP, HFETCH, EPZ_REQ_VALUE, STORE, FOURPLUS, DUP, HFETCH, EPZ_REQ_INDEX, STORE, FOURPLUS, HFETCH, EPZ_REQ_LENGTH, STORE, EPZ_REQ_TYPE, LIT, 0x5, CELLS, DUMPW, EPZ_REQ, FETCH, DUP, LIT, 0x6, EQU, QBRANCH, 0x2C, LPARENSQUOTRPAREN, 0x6E655319, 0x676E6964, 0x76656420, 0x20656369, 0x63736564, 0x74706972, 0x726F, TYPE, EPZ_SEND_DEVICE_DESCRIPTOR, DUP, LIT, 0x5, EQU, QBRANCH, 0x30, LPARENSQUOTRPAREN, 0x74655313, 0x676E6974, 0x64646120, 0x73736572, 0x206F7420, TYPE, EPZ_REQ_VALUE, FETCH, DOT, EPZ_SEND_ZLENGTH_DATA, DROP, CR, EXIT

    defword "EP0-HANDLE-IN", EPZ_HANDLE_IN, 0x0
    .word LIT, 0x80, USB_EPZR, CLEAR_BITS, LPARENSQUOTRPAREN, 0x4E4902, TYPE, EPZ_REQ, FETCH, LIT, 0x5, EQU, QBRANCH, 0x70, LIT, 0x1, LIT, 0x0, EP_RX_STATESTORE, LIT, 0x0, EPZ_REQ, STORE, EPZ_REQ_VALUE, FETCH, DUP, LIT, 0x80, OR, USB_DADDR, STORE, USB_EPZR, DUP, FETCH, LIT, 0xFFF0, AND, ROT, OR, SWAP, STORE, LIT, 0x1, LIT, 0x0, EP_TX_STATESTORE, EXIT
