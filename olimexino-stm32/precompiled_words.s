    ...
    .word LIT, 0x0, EP_CLEAR_CTR_RX, LIT, 0x2, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, LIT, 0x0, USB_BTABLE_RX, DUP, CFETCH, EPZ_REQ_TYPE, STORE, ONEPLUS, DUP, CFETCH, EPZ_REQ, STORE, LIT, 0x3, PLUS, DUP, HFETCH, EPZ_REQ_VALUE, STORE, FOURPLUS, DUP, HFETCH, EPZ_REQ_INDEX, STORE, FOURPLUS, HFETCH, EPZ_REQ_LENGTH, STORE, EPZ_REQ, FETCH, DUP, LIT, 0x6, EQU, QBRANCH, 0x8, EPZ_SEND_DEVICE_DESCRIPTOR, LIT, 0x5, EQU, QBRANCH, 0x8, EPZ_SEND_ZLENGTH_DATA, EXIT

    defword "EP0-HANDLE-IN", EPZ_HANDLE_IN, 0x0
    .word LIT, 0x0, EP_CLEAR_CTR_TX, EPZ_REQ, FETCH, LIT, 0x5, EQU, QBRANCH, 0x30, LIT, 0x0, EPZ_REQ, STORE, EPZ_REQ_VALUE, FETCH, LIT, 0x80, OR, USB_DADDR, STORE, EPZ_PENDING, SLICENUM, QBRANCH, 0x20, EPZ_REQ_LENGTH, FETCH, EPZ_SEND_PENDING, LIT, 0x3, BRANCH, 0xC, LIT, 0x1, LIT, 0x0, EP_TX_STATESTORE, LIT, 0x1, LIT, 0x0, EP_RX_STATESTORE, EXIT
    ...
    .word NIP, USB_EPZR, FETCH, SWAP, QBRANCH, 0x58, DUP, LIT, 0x80, AND, QBRANCH, 0x14, DROP, EPZ_HANDLE_IN, BRANCH, 0x28, LIT, 0x800, AND, QBRANCH, 0x10, EPZ_SETUP, BRANCH, 0x8, EPZ_HANDLE_OUT, BRANCH, 0xC, DROP, EPZ_HANDLE_IN, EXIT
