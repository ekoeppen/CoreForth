    ...
    .word LIT, 0x0, USB_BTABLE, STORE, LIT, 0x32000010, USB_EPZR, STORE, LIT, 0x40, LIT, 0x0, USB_BTABLE_RX, STORE, LIT, 0x80, LIT, 0x0, USB_BTABLE_TX, STORE, LIT, 0x40, LIT, 0x0, USB_BTABLE_RXNUM, STORE, LIT, 0x6000020, USB_EPTWOR, STORE, LIT, 0x100, LIT, 0x2, USB_BTABLE_TX, STORE, LIT, 0x40, LIT, 0x2, USB_BTABLE_TXNUM, STORE, LIT, 0x30, USB_EP3R, STORE, LIT, 0x110, LIT, 0x3, USB_BTABLE_RX, STORE, LIT, 0x40, LIT, 0x3, USB_BTABLE_RXNUM, STORE, LIT, 0x0, USB_EPONER, STORE, LIT, 0xC0, LIT, 0x1, USB_BTABLE_TX, STORE, LIT, 0x40, LIT, 0x1, USB_BTABLE_TXNUM, STORE, LIT, 0x80, USB_DADDR, STORE, EXIT

    defword "USB-SUSPEND", USB_SUSPEND, 0x0
    .word LIT, 0xC, USB_CNTR, SET_BITS, EXIT

    defword "USB-IRQ", USB_IRQ, 0x0
    .word LIT, 0x0, USB_ISTR, DUP, FETCH, DUP, DOT, LIT, 0x400, OVER, AND, QBRANCH, 0x8, USB_RESET, LIT, 0x800, OVER, AND, QBRANCH, 0x8, USB_SUSPEND, USB_ISTR_SHADOW, STORE, STORE, RETI
    ...
    .word LIT, 0x0, USB_ISTR_SHADOW, STORE, USB_SET_IRQ_HANDLER, LIT, 0x1, USB_CNTR, STORE, LIT, 0x0, USB_CNTR, STORE, LIT, 0x0, USB_ISTR, STORE, LIT, 0x1C00, USB_CNTR, STORE, LIT, 0x0, USB_ISTR, STORE, LIT, 0xBE00, USB_CNTR, STORE, LIT, 0x180000, NVIC_SETENA_BASE, STORE, EXIT
