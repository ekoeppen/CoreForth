    ...
    .word EPZ_REQ_LENGTH, FETCH, ZGT, QBRANCH, 0x34, LPARENSQUOTRPAREN, 0x686E5513, 0x6C646E61, 0x72206465, 0x65757165, 0x203A7473, TYPE, EPZ_REQ_TYPE, LIT, 0x5, CELLS, DUMPW, EPZ_SEND_ZLENGTH_DATA, EXIT

    defword "EP0-SETUP", EPZ_SETUP, 0x0
    .word LIT, 0x0, EP_CLEAR_CTR_RX, LIT, 0x2, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, LIT, 0x0, USB_BTABLE_RX, DUP, CFETCH, EPZ_REQ_TYPE, STORE, ONEPLUS, DUP, CFETCH, EPZ_REQ, STORE, LIT, 0x3, PLUS, DUP, CFETCH, EPZ_REQ_VALUEZ, STORE, ONEPLUS, DUP, CFETCH, EPZ_REQ_VALUEONE, STORE, LIT, 0x3, PLUS, DUP, HFETCH, EPZ_REQ_INDEX, STORE, FOURPLUS, HFETCH, EPZ_REQ_LENGTH, STORE, EPZ_REQ, FETCH, LIT, 0x5, OVER, EQU, QBRANCH, 0x14, DROP, EPZ_SET_ADDRESS_START, BRANCH, 0x98, LIT, 0x6, OVER, EQU, QBRANCH, 0x14, DROP, EPZ_SEND_DESCRIPTOR, BRANCH, 0x70, LIT, 0x9, OVER, EQU, QBRANCH, 0x14, DROP, EPZ_SET_CONFIGURATION, BRANCH, 0x48, LIT, 0x21, OVER, EQU, QBRANCH, 0x14, DROP, EPZ_SEND_CLASS_RESPONSE, BRANCH, 0x20, EPZ_REQ_TYPE, LIT, 0x5, CELLS, DUMPW, EPZ_SEND_ZLENGTH_DATA, DROP, EXIT
    ...
    defword "USB", USB, 0x0
    .word LIT, 0x1, USB_DISCSTORE, USB_INIT, LIT, EPZ_HANDLER, USB_CTR_HANDLERS, STORE, USB_ENABLE, EXIT
