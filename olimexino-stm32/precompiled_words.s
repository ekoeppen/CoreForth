    ...
    .word LIT, 0x0, USB_BTABLE, STORE, USB_PMA, LIT, 0x400, LIT, 0x0, FILL, LIT, 0x3210, USB_EPZR, STORE, LIT, 0x40, LIT, 0x0, USB_BTABLE_RX, HSTORE, LIT, 0x8400, LIT, 0x0, USB_BTABLE_RXNUM, HSTORE, LIT, 0x80, LIT, 0x0, USB_BTABLE_TX, HSTORE, LIT, 0x40, LIT, 0x0, USB_BTABLE_TXNUM, HSTORE, LIT, 0x0, USB_EPONER, STORE, LIT, 0xC0, LIT, 0x1, USB_BTABLE_TX, HSTORE, LIT, 0x40, LIT, 0x1, USB_BTABLE_TXNUM, HSTORE, LIT, 0x620, USB_EPTWOR, STORE, LIT, 0x100, LIT, 0x2, USB_BTABLE_TX, HSTORE, LIT, 0x40, LIT, 0x2, USB_BTABLE_TXNUM, HSTORE, LIT, 0x30, USB_EP3R, STORE, LIT, 0x110, LIT, 0x3, USB_BTABLE_RX, HSTORE, LIT, 0x8400, LIT, 0x3, USB_BTABLE_RXNUM, HSTORE, LIT, 0x80, USB_DADDR, STORE, EXIT
    ...
    .word CR, LPARENSQUOTRPAREN, 0x52494405, 0x203A, TYPE, DOT, LPARENSQUOTRPAREN, 0x3A504504, 0x20, TYPE, DUP, DOT, LPARENSQUOTRPAREN, 0x78504506, 0x203A52, TYPE, DUP, CELLS, USB_EPZR, PLUS, FETCH, DOT, DUP, USB_BTABLE_RX, FETCH, TWOMUL, USB_PMA, PLUS, OVER, USB_BTABLE_RXNUM, FETCH, LIT, 0x3FF, AND, TWOMUL, DUMP, CELLS, USB_EPZR, PLUS, LIT, 0x8080, SWAP, CLEAR_BITS, EXIT
    ...
    .word LIT, 0x8080, USB_EPZR, CLEAR_BITS, LPARENSQUOTRPAREN, 0x54455307, 0x203A5055, TYPE, LIT, 0x0, USB_BTABLE_RX, FETCH, TWOMUL, USB_PMA, PLUS, DUP, CFETCH, DOT, ONEPLUS, DUP, CFETCH, DOT, LIT, 0x3, PLUS, DUP, HFETCH, DOT, FOURPLUS, DUP, HFETCH, DOT, FOURPLUS, HFETCH, DOT, LIT, 0x12, LIT, 0x0, USB_BTABLE_TXNUM, STORE, USB_DEVICE_DESCRIPTOR, LIT, 0x0, USB_BTABLE_TX, FETCH, TWOMUL, USB_PMA, PLUS, LIT, 0x24, CMOVE, USB_EPZR, DUP, FETCH, LIT, 0xCFCF, AND, LIT, 0x3030, OR, SWAP, STORE, EXIT
    ...
    .word LIT, 0x8000, USB_EPZR, CLEAR_BITS, LPARENSQUOTRPAREN, 0x54554F03, TYPE, USB_EPZR, DUP, FETCH, LIT, 0xFFCF, AND, LIT, 0x10, OR, SWAP, STORE, EXIT
