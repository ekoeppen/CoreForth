    ...
    .word 0x112, 0x200, 0x2, 0x4000, 0x1EAF, 0x4, 0x200, 0x0, 0x1
    ...
    defvar "EP0-REQ-VALUE", EPZ_REQ_VALUE, 0x4
    ...
    .word CELLS, USB_EPZR, PLUS, DUP, FETCH, ROT, LIT, 0x4, ROTATE, XOR, OVER, FETCH, LIT, 0xFFCF, AND, OR, SWAP, STORE, EXIT

    defword "EP-RX-STATE!", EP_RX_STATESTORE, 0x0
    .word CELLS, USB_EPZR, PLUS, DUP, FETCH, ROT, LIT, 0xC, ROTATE, XOR, OVER, FETCH, LIT, 0xCFFF, AND, OR, SWAP, STORE, EXIT
    ...
    .word USB_DEVICE_DESCRIPTOR, LIT, 0x24, EPZ_PENDING, SLICESTORE, EPZ_REQ_LENGTH, FETCH, EPZ_SEND_PENDING, LIT, 0x3, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, EXIT

    defword "EP0-SEND-0LENGTH-DATA", EPZ_SEND_ZLENGTH_DATA, 0x0
    .word LIT, 0x0, LIT, 0x0, USB_BTABLE_TXNUM, STORE, LIT, 0x3, LIT, 0x0, EP_TX_STATESTORE, EXIT

    defword "EP0-SETUP", EPZ_SETUP, 0x0
    .word LIT, 0x8080, USB_EPZR, CLEAR_BITS, LIT, 0x2, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, LPARENSQUOTRPAREN, 0x74655307, 0x203A7075, TYPE, LIT, 0x0, USB_BTABLE_RX, DUP, CFETCH, EPZ_REQ_TYPE, STORE, ONEPLUS, DUP, CFETCH, EPZ_REQ, STORE, LIT, 0x3, PLUS, DUP, HFETCH, EPZ_REQ_VALUE, STORE, FOURPLUS, DUP, HFETCH, EPZ_REQ_INDEX, STORE, FOURPLUS, HFETCH, EPZ_REQ_LENGTH, STORE, EPZ_REQ_TYPE, LIT, 0x5, CELLS, DUMPW, EPZ_REQ, FETCH, DUP, LIT, 0x6, EQU, QBRANCH, 0x2C, LPARENSQUOTRPAREN, 0x6E655319, 0x676E6964, 0x76656420, 0x20656369, 0x63736564, 0x74706972, 0x726F, TYPE, EPZ_SEND_DEVICE_DESCRIPTOR, DUP, LIT, 0x5, EQU, QBRANCH, 0x44, LPARENSQUOTRPAREN, 0x74655313, 0x676E6974, 0x64646120, 0x73736572, 0x206F7420, TYPE, EPZ_REQ_VALUE, FETCH, DOT, EPZ_SEND_ZLENGTH_DATA, LIT, 0x3, LIT, 0x0, EP_RX_STATESTORE, DROP, CR, EXIT

    defword "EP0-HANDLE-IN", EPZ_HANDLE_IN, 0x0
    .word LIT, 0x80, USB_EPZR, CLEAR_BITS, LIT, 0x2, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, LPARENSQUOTRPAREN, 0x204E4903, TYPE, EPZ_REQ, FETCH, DUP, DOT, LIT, 0x5, EQU, QBRANCH, 0x60, LIT, 0x0, EPZ_REQ, STORE, EPZ_SEND_ZLENGTH_DATA, EPZ_REQ_VALUE, FETCH, DUP, LIT, 0x80, OR, USB_DADDR, STORE, DROP, LIT, 0x3, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, BRANCH, 0x18, LIT, 0x1, LIT, 0x0, EP_TX_STATESTORE, CR, EXIT

    defword "EP0-HANDLE-OUT", EPZ_HANDLE_OUT, 0x0
    .word LIT, 0x8000, USB_EPZR, CLEAR_BITS, LPARENSQUOTRPAREN, 0x54554F03, TYPE, EXIT

    defword "EP0-HANDLER", EPZ_HANDLER, 0x0
    .word NIP, USB_EPZR, FETCH, DUP, DOT, LIT, 0x800, AND, QBRANCH, 0x14, DROP, EPZ_SETUP, BRANCH, 0x1C, QBRANCH, 0x10, EPZ_HANDLE_OUT, BRANCH, 0x8, EPZ_HANDLE_IN, CR, EXIT

    defword "USB-TEST", USB_TEST, 0x0
    .word USB_INIT, LIT, EPZ_HANDLER, USB_CTR_HANDLERS, STORE, EXIT
