    ...
    .word LIT, 0x0, LPARENDORPAREN, OVER, CFETCH, OVER, CSTORE, ONEPLUS, I, ONEMINUS, LIT, 0x1, AND, ZEQU, QBRANCH, 0x10, LIT, 0x2, PLUS, SWAP, ONEPLUS, SWAP, LPARENLOOPRPAREN, QBRANCH, 0xFFFFFFAC, TWODROP, EXIT

    defword "OUT-HANDLER", OUT_HANDLER, 0x0
    .word TWODROP, LIT, 0x3, EP_CLEAR_CTR_RX, LIT, 0x3, USB_BTABLE_RX, PAD, ONEPLUS, LIT, 0x3, USB_BTABLE_RXNUM, HFETCH, LIT, 0x3FF, AND, DUP, PAD, CSTORE, PMAGT, LIT, 0x3, LIT, 0x3, EP_RX_STATESTORE, EXIT

    defword "IN-HANDLER", IN_HANDLER, 0x0
    .word DROP, EP_CLEAR_CTR_TX, EXIT

    defword "USB-TX", USB_TX, 0x0
    .word DUP, LIT, 0x1, USB_BTABLE_TXNUM, STORE, LIT, 0x1, USB_BTABLE_TX, SWAP, GTPMA, LIT, 0x3, LIT, 0x1, EP_TX_STATESTORE, EXIT
