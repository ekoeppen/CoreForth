    ...
    .word LIT, 0x0, EP_CLEAR_CTR, LIT, 0x2, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, LPARENSQUOTRPAREN, 0x74655307, 0x203A7075, TYPE, USB_EPZR, FETCH, DOT, LIT, 0x0, USB_BTABLE_RX, DUP, CFETCH, EPZ_REQ_TYPE, STORE, ONEPLUS, DUP, CFETCH, EPZ_REQ, STORE, LIT, 0x3, PLUS, DUP, HFETCH, EPZ_REQ_VALUE, STORE, FOURPLUS, DUP, HFETCH, EPZ_REQ_INDEX, STORE, FOURPLUS, HFETCH, EPZ_REQ_LENGTH, STORE, EPZ_REQ_TYPE, LIT, 0x5, CELLS, DUMPW, EPZ_REQ, FETCH, DUP, LIT, 0x6, EQU, QBRANCH, 0x8, EPZ_SEND_DEVICE_DESCRIPTOR, DUP, LIT, 0x5, EQU, QBRANCH, 0x8, EPZ_SEND_ZLENGTH_DATA, DROP, LIT, 0x3, LIT, 0x0, EP_RX_STATESTORE, USB_EPZR, FETCH, DOT, CR, EXIT

    defword "EP0-HANDLE-IN", EPZ_HANDLE_IN, 0x0
    .word LIT, 0x0, EP_CLEAR_CTR, LPARENSQUOTRPAREN, 0x204E4903, TYPE, EPZ_REQ, FETCH, DUP, DOT, LIT, 0x5, EQU, QBRANCH, 0x30, LIT, 0x0, EPZ_REQ, STORE, EPZ_REQ_VALUE, FETCH, LIT, 0x80, OR, USB_DADDR, STORE, EPZ_PENDING, SLICENUM, DUP, DOT, QBRANCH, 0x20, EPZ_REQ_LENGTH, FETCH, EPZ_SEND_PENDING, LIT, 0x3, BRANCH, 0xC, LIT, 0x1, LIT, 0x0, EP_TX_STATESTORE, LIT, 0x3, LIT, 0x0, EP_RX_STATESTORE, CR, EXIT

    defword "EP0-HANDLE-OUT", EPZ_HANDLE_OUT, 0x0
    .word LIT, 0x0, EP_CLEAR_CTR, LPARENSQUOTRPAREN, 0x54554F03, TYPE, LIT, 0x0, USB_BTABLE_RX, LIT, 0x10, DUMP, LIT, 0x1, LIT, 0x0, EP_TX_STATESTORE, LIT, 0x3, LIT, 0x0, EP_RX_STATESTORE, CR, EXIT
