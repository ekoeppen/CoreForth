    ...
    .word EPZ_PENDING, DUP, CELL, PLUS, FETCH, ROT, MIN, DUP, LIT, 0x0, USB_BTABLE_TXNUM, STORE, GTR, DUP, FETCH, LIT, 0x0, USB_BTABLE_TX, RFETCH, CMOVE, RGT, SWAP, SLASHSLICE, EXIT

    defword "EP0-SETUP", EPZ_SETUP, 0x0
    .word LIT, 0x8080, USB_EPZR, CLEAR_BITS, LPARENSQUOTRPAREN, 0x54455307, 0x203A5055, TYPE, USB_DEVICE_DESCRIPTOR, LIT, 0x24, EPZ_PENDING, SLICESTORE, LIT, 0x0, USB_BTABLE_RX, ONEPLUS, LIT, 0x3, PLUS, FOURPLUS, FOURPLUS, HFETCH, EPZ_SEND_PENDING, USB_EPZR, DUP, FETCH, LIT, 0xCFCF, AND, LIT, 0x3030, OR, SWAP, STORE, EXIT
