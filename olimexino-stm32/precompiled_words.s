    ...
    .word LIT, 0x0, USB_ISTR, DUP, FETCH, DUP, DOT, LIT, 0x400, OVER, AND, QBRANCH, 0x8, USB_RESET, LIT, 0x800, OVER, AND, QBRANCH, 0x8, USB_SUSPEND, LIT, 0x1000, OVER, AND, QBRANCH, 0x8, USB_WAKE, LIT, 0x8000, AND, QBRANCH, 0x8, USB_CTR, STORE, RETI
    ...
    .word 0x112, 0x101, 0x2, 0x4000, 0x1EAF, 0x0, 0x0, 0x0, 0x1
    ...
    .word LIT, 0x0, EP_CLEAR_CTR_RX, LIT, 0x2, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, LPARENSQUOTRPAREN, 0x74655307, 0x203A7075, TYPE, USB_EPZR, FETCH, DOT, LIT, 0x0, USB_BTABLE_RX, DUP, CFETCH, EPZ_REQ_TYPE, STORE, ONEPLUS, DUP, CFETCH, EPZ_REQ, STORE, LIT, 0x3, PLUS, DUP, HFETCH, EPZ_REQ_VALUE, STORE, FOURPLUS, DUP, HFETCH, EPZ_REQ_INDEX, STORE, FOURPLUS, HFETCH, EPZ_REQ_LENGTH, STORE, EPZ_REQ, FETCH, DUP, DOT, DUP, LIT, 0x6, EQU, QBRANCH, 0x8, EPZ_SEND_DEVICE_DESCRIPTOR, DUP, LIT, 0x5, EQU, QBRANCH, 0x8, EPZ_SEND_ZLENGTH_DATA, DROP, LIT, 0x3, LIT, 0x0, EP_RX_STATESTORE, USB_EPZR, FETCH, DOT, CR, EXIT

    defword "EP0-HANDLE-IN", EPZ_HANDLE_IN, 0x0
    .word LIT, 0x0, EP_CLEAR_CTR, LPARENSQUOTRPAREN, 0x204E4903, TYPE, EPZ_REQ, FETCH, DUP, DOT, LIT, 0x5, EQU, QBRANCH, 0x38, LIT, 0x0, EPZ_REQ, STORE, EPZ_REQ_VALUE, FETCH, DUP, LIT, 0x80, OR, USB_DADDR, STORE, DROP, EPZ_PENDING, SLICENUM, DUP, DOT, QBRANCH, 0x20, LIT, 0x40, EPZ_SEND_PENDING, LIT, 0x3, BRANCH, 0xC, LIT, 0x1, LIT, 0x0, EP_TX_STATESTORE, LIT, 0x3, LIT, 0x0, EP_RX_STATESTORE, CR, EXIT

    defword "EP0-HANDLE-OUT", EPZ_HANDLE_OUT, 0x0
    .word LIT, 0x0, EP_CLEAR_CTR, LPARENSQUOTRPAREN, 0x54554F03, TYPE, LIT, 0x1, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, CR, EXIT

    defword "EP0-HANDLER", EPZ_HANDLER, 0x0
    .word LPARENSQUOTRPAREN, 0x30504506, 0x20203A, TYPE, NIP, USB_EPZR, FETCH, DUP, DOT, CR, LIT, 0x800, AND, QBRANCH, 0x14, DROP, EPZ_SETUP, BRANCH, 0x1C, QBRANCH, 0x10, EPZ_HANDLE_OUT, BRANCH, 0x8, EPZ_HANDLE_IN, LPARENSQUOTRPAREN, 0x3050450A, 0x6E6F6420, 0x202E65, TYPE, USB_EPZR, FETCH, DOT, CR, CR, EXIT
