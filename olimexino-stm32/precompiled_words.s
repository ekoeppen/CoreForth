    ...
    .word LIT, 0x8080, USB_EPZR, CLEAR_BITS, LPARENSQUOTRPAREN, 0x54455307, 0x203A5055, TYPE, LIT, 0x0, USB_BTABLE_RX, DUP, CFETCH, EPZ_REQ_TYPE, STORE, ONEPLUS, DUP, CFETCH, EPZ_REQ, STORE, LIT, 0x3, PLUS, DUP, HFETCH, EPZ_REQ_VALUE, STORE, FOURPLUS, DUP, HFETCH, EPZ_REQ_INDEX, STORE, FOURPLUS, HFETCH, EPZ_REQ_LENGTH, STORE, EPZ_REQ_TYPE, LIT, 0x5, CELLS, DUMPW, EPZ_REQ, FETCH, DUP, LIT, 0x6, EQU, QBRANCH, 0x18, USB_DEVICE_DESCRIPTOR, LIT, 0x24, EPZ_PENDING, SLICESTORE, DUP, LIT, 0x5, EQU, QBRANCH, 0x3C, LIT, 0x0, EPZ_PENDING, SLICENUMSTORE, LPARENSQUOTRPAREN, 0x74655313, 0x676E6974, 0x64646120, 0x73736572, 0x206F7420, TYPE, EPZ_REQ_VALUE, FETCH, DOT, DROP, EPZ_REQ_LENGTH, FETCH, EPZ_SEND_PENDING, USB_EPZR, DUP, FETCH, LIT, 0xCFCF, AND, LIT, 0x3030, OR, SWAP, STORE, EXIT
