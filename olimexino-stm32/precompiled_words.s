    ...
    .word 0x112, 0x101, 0x2, 0x4000, 0x15BA, 0xC04E, 0x0, 0x201, 0x100

    defdata "CONFIG$", CONFIGVAL
    .word 0x209, 0x40, 0x102, 0xC000, 0x980, 0x4, 0x100, 0x202, 0x1, 0x2405, 0x100, 0x510, 0x124, 0x103, 0x2404, 0x602, 0x2405, 0x6, 0x701, 0x8205, 0x4003, 0xFF00, 0x409, 0x1, 0xA02, 0x0, 0x700, 0x305, 0x4002, 0x0, 0x507, 0x281, 0x40, 0x0
    ...
    .word EPZ_PENDING, DUP, CELL, PLUS, FETCH, TWOSLASH, ROT, MIN, DUP, LIT, 0x0, USB_BTABLE_TXNUM, STORE, TWOMUL, GTR, DUP, FETCH, LIT, 0x0, USB_BTABLE_TX, RFETCH, ALIGNED, ALIGNED_MOVEGT, RGT, SWAP, SLASHSLICE, EXIT

    defword "EP0-SEND-DESCRIPTOR", EPZ_SEND_DESCRIPTOR, 0x0
    .word EPZ_REQ_VALUEONE, FETCH, LIT, 0x1, OVER, EQU, QBRANCH, 0x20, DROP, DEVICEVAL, DUP, CFETCH, TWOMUL, BRANCH, 0x84, LIT, 0x2, OVER, EQU, QBRANCH, 0x28, DROP, CONFIGVAL, DUP, CELL, PLUS, HFETCH, TWOMUL, BRANCH, 0x48, LIT, 0x3, OVER, EQU, QBRANCH, 0x28, DROP, EPZ_REQ_VALUEZ, FETCH, STRINGVAL, DUP, CFETCH, TWOMUL, BRANCH, 0xC, NULLVAL, DROP, EPZ_PENDING, SLICESTORE, EPZ_REQ_LENGTH, FETCH, EPZ_SEND_PENDING, LIT, 0x3, LIT, 0x0, TWODUP, EP_TX_STATESTORE, EP_RX_STATESTORE, EXIT
