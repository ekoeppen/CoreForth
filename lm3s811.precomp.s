    ...
    .word ROT, ZBRANCH, 0xc, TYPE, ABORT, TWODROP, EXIT
    ...
    .word LIT, 0x0, STATE, STORE, TIB, LPARENSOURCERPAREN, STORE, LIT, 0x0, GTSOURCE, STORE, ACCEPT, SOURCENUM, STORE, SPACE, LPARENINTERPRETRPAREN, ZBRANCH, 0x20, DROP, LPARENSQUOTRPAREN, 0x6b6f2004, 0x20, TYPE, BRANCH, 0x18, COUNT, TYPE, LIT, 0x63, EMIT, CR, EXIT

    defword "YIELD", YIELD, 0x80
    .word LIT, LIT, COMMA, COMMA, LIT, LIT, COMMA, LATEST, FETCH, LINKGT, GTBODY, COMMA, LIT, LPARENYIELDRPAREN, COMMA, EXIT

    defword "(YIELD)", LPARENYIELDRPAREN, 0x0
    .word ROT, ZBRANCH, 0x14, STORE, RDROP, BRANCH, 0x8, TWODROP, EXIT
    ...
    .word CLS, LIT, 0x0, DUP, AT_XY, LIST, LIT, 0x0, STOREXY, KEY, SWAP, QCH, SWAP, LIT, 0x18, EQU, ZBRANCH, 0xffffffdc, UPDATE, DROP, L, EXIT

    defword "?CH", QCH, 0x0
    .word OVER, BL, MINUS, LIT, 0x5f, ULT, ZBRANCH, 0x10, STORECH, ONEPLUS, EXIT, OVER, KEY_LEFT, EQU, ZBRANCH, 0x8, ONEMINUS, OVER, KEY_RIGHT, EQU, ZBRANCH, 0x8, ONEPLUS, OVER, KEY_UP, EQU, ZBRANCH, 0xc, CSLASHL, MINUS, OVER, KEY_DOWN, EQU, ZBRANCH, 0xc, CSLASHL, PLUS, OVER, KEY_HOME, EQU, ZBRANCH, 0x14, CSLASHL, ONEMINUS, INVERT, AND, OVER, KEY_DELETE, EQU, ZBRANCH, 0x14, DUP, TAILLT, DUP, DOTTAIL, OVER, KEY_BACKSPACE, EQU, ZBRANCH, 0x1c, ONEMINUS, DUP, TAILLT, STOREXY, DUP, DOTTAIL, OVER, KEY_PGUP, EQU, ZBRANCH, 0x1c, UPDATE, B, L, DROP, LIT, 0x0, OVER, KEY_PGDOWN, EQU, ZBRANCH, 0x1c, UPDATE, N, L, DROP, LIT, 0x0, OVER, LIT, 0xd, EQU, ZBRANCH, 0x18, CSLASHL, TWODUP, MOD, MINUS, PLUS, EXIT
    ...
    .word DUP, SCR, STORE, DOTD, LPARENSQUOTRPAREN, 0x63732004, 0x72, TYPE, CR, LIT, 0x0, DUP, LL, CR, ONEPLUS, DUP, LIT, 0x10, EQU, ZBRANCH, 0xffffffdc, DROP, EXIT
    ...
    .word LPARENLPARENBLOCKRPARENRPAREN, SWAP, DUP, BLOCKNUM, FETCH, LTGT, ZBRANCH, 0x1c, TWODUP, LPARENBLOCKRPAREN, BLOCKNUM, STORE, BRANCH, 0x8, DROP, EXIT
    ...
    .word LIT, 0x0, LPARENDORPAREN, DUP, I, PLUS, CFETCH, DISP_EMIT, LPARENLOOPRPAREN, ZBRANCH, 0xffffffe4, DROP, EXIT

    defword "DISP-EMIT", DISP_EMIT, 0x0
    .word LIT, 0x40, ITWOCMSTORE, ITWOCM_SEND_START, ITWOC_DELAY, LIT, 0x20, MINUS, LIT, 0x5, MUL, DISP_FONT, PLUS, LIT, 0x5, LIT, 0x0, LPARENDORPAREN, DUP, I, PLUS, CFETCH, ITWOCMSTORE, ITWOCM_SEND_RUN, ITWOC_DELAY, LPARENLOOPRPAREN, ZBRANCH, 0xffffffdc, DROP, LIT, 0x0, ITWOCMSTORE, ITWOCM_SEND_STOP, ITWOC_DELAY, EXIT
    ...
    .word ITWOCM_SINGLE_SEQ_STARTSTORE, DROP, LIT, 0x96, LIT, 0x0, LPARENDORPAREN, DUP, ITWOCMSTORE, ITWOCM_SEND_RUN, ITWOC_DELAY, LPARENLOOPRPAREN, ZBRANCH, 0xffffffe8, ITWOCMSTORE, ITWOCM_SEND_STOP, ITWOC_DELAY, EXIT
    ...
    .word DUP, CFETCH, SWAP, ONEPLUS, SWAP, ONEPLUS, LIT, 0x1, LPARENDORPAREN, ITWOCM_SINGLE_SEQSTORE, LPARENLOOPRPAREN, ZBRANCH, 0xfffffff4, DROP, EXIT
    ...
    .word DUP, CFETCH, LIT, 0x1, LPARENDORPAREN, DUP, I, PLUS, CFETCH, ITWOCMSTORE, I, LIT, 0x1, EQU, LIT, 0x2, AND, LIT, 0x1, OR, ITWOCMCS, CSTORE, ITWOC_DELAY, LPARENLOOPRPAREN, ZBRANCH, 0xffffffb0, DUP, CFETCH, PLUS, DUP, CFETCH, ITWOCMSTORE, SWAP, ITWOCMCS, CSTORE, ITWOC_DELAY, ONEPLUS, EXIT

    defword "I2C-DELAY", ITWOC_DELAY, 0x0
    .word LPARENITWOC_DELAYRPAREN, FETCH, ONEMINUS, DUP, ZEQU, ZBRANCH, 0xfffffff0, DROP, EXIT
