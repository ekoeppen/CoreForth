    ...
    .word LIT, 0x3ff, AND, DUP, CSLASHL, SLASHMOD, ONEPLUS, AT_XY, EXIT
    ...
    .word DUP, SCR, STORE, DOTD, LPARENSQUOTRPAREN, 0x72637303, TYPE, CR, LIT, 0x0, DUP, LL, CR, ONEPLUS, DUP, LIT, 0x10, EQU, ZBRANCH, 0xffffffdc, DROP, EXIT
    ...
    .word PAD, BLOCKNUM, FETCH, LPARENUPDATERPAREN, EXIT

    defword "BLOCK", BLOCK, 0x0
    .word PAD, SWAP, DUP, BLOCKNUM, FETCH, LTGT, ZBRANCH, 0x1c, TWODUP, LPARENBLOCKRPAREN, BLOCKNUM, STORE, BRANCH, 0x8, DROP, EXIT
    ...
    .word DROP, LIT, 0x400, BLANK, EXIT
