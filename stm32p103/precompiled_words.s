    ...
    defword "LED-ENABLE", LED_ENABLE, 0x0
    .word GPIOC, GPIO_CRH, DUP, FETCH, LIT, 0xFFF0FFFF, AND, LIT, 0x10000, OR, SWAP, STORE, EXIT

    defword "LED!", LEDSTORE, 0x0
    ...
    .word GPIOC, GPIO_CRH, DUP, FETCH, LIT, 0xFFFF0FFF, AND, LIT, 0xFFFF3FFF, OR, SWAP, STORE, EXIT

    defword "USB-DISC!", USB_DISCSTORE, 0x0
    .word CELLS, GPIOC, GPIO_BRR, SWAP, MINUS, LIT, RFETCH, SWAP, STORE, EXIT
    ...
    .word LIT, 0x0, USB_ISTR, DUP, FETCH, LIT, 0x400, OVER, AND, QBRANCH, 0x8, USB_RESET, LIT, RFETCH, OVER, AND, QBRANCH, 0x8, USB_SUSPEND, LIT, 0x1000, OVER, AND, QBRANCH, 0x8, USB_WAKE, LIT, 0x8000, AND, QBRANCH, 0x8, USB_CTR, STORE, RETI
    ...
    .word LIT, 0x0, USB_DISCSTORE, LIT, 0x180000, NVIC, NVIC_SETENA_BASE, SET_BITS, LIT, 0x1, USB_CNTR, STORE, LIT, 0x0, USB_CNTR, STORE, LIT, 0x0, USB_ISTR, STORE, LIT, QNUMBER, USB_CNTR, STORE, LIT, 0x0, USB_ISTR, STORE, USB_DEFAULT_IRQMASK, USB_CNTR, STORE, EXIT
    ...
    .word NIP, QBRANCH, 0x38, USB_EPZR, FETCH, LIT, RFETCH, AND, QBRANCH, 0x10, EPZ_SETUP, BRANCH, 0x8, EPZ_HANDLE_OUT, BRANCH, 0x8, EPZ_HANDLE_IN, EXIT
    ...
    .word LIT, 0x0, UARTONE, UART_CRONE, STORE, USB, LIT, USB_EMIT, TICKEMIT, STORE, LIT, USB_TX, TICKTYPE, STORE, EXIT
