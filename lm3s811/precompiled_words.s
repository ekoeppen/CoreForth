    ...
    defword "KEY", KEY, 0x0, DEFER_XT
    .word READWKEY

    defword "ACCEPT", ACCEPT, 0x0, DEFER_XT
    .word READLINE

    defword "EMIT", EMIT, 0x0, DEFER_XT
    .word 0x20002390
    ...
    .word SYSCTL_RCC, DUP, DUP, FETCH, LIT, 0xF83FFFFF, AND, LIT, RDROP, OR, SWAP, STORE, DUP, DUP, FETCH, LIT, 0xFFFFCFCF, AND, SWAP, STORE, DUP, FETCH, LIT, 0xF87FFC3F, AND, LIT, 0x1C002C0, OR, SWAP, STORE, SYSCTL_RIS, DUP, FETCH, LIT, 0x40, AND, QBRANCH, 0xFFFFFFE8, DROP, EXIT
