    ...
    .word CSLASHBLK, MUL, LIT, 0x88000, PLUS, SWAP, CSLASHBLK, CMOVE, EXIT

    defword "(UPDATE-PAGE)", LPARENUPDATE_PAGERPAREN, 0x0
    .word TWODUP, SWAP, LIT, 0x100, CMOVE, ROT, DUP, FLASH_PAGE, ONEPLUS, ROT, LIT, 0x100, PLUS, ROT, LIT, 0x100, PLUS, EXIT

    defword "(UPDATE)", LPARENUPDATERPAREN, 0x0
    .word DUP, TWOMUL, TWOMUL, LIT, 0x80, PLUS, SWAP, CSLASHBLK, MUL, LIT, 0x88000, PLUS, ROT, LPARENUPDATE_PAGERPAREN, LPARENUPDATE_PAGERPAREN, LPARENUPDATE_PAGERPAREN, LPARENUPDATE_PAGERPAREN, TWODROP, DROP, EXIT
